...
class HomeNewsCampaignComponent extends React.Component {
    ...
    requestNews = () => {
        ...
        fetch("https://api.mwactu.fr/v1/news/?category=3&limit=ok")
            .then(res => res.json())
            .then(
                (result) => {
                    this.setState({
        ...
        return (
            <View style={{marginBottom: 15}}>
                <View style={{marginLeft: 15, marginBottom: 8, flexDirection: 'row'}}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('NewsAll', {idCategory: 3})} style={{paddingLeft: 10, paddingRight: 10, backgroundColor: 'rgba(88,88,88,0.48)', marginLeft: 10, borderRadius: 25 / 2, alignItems: 'center', justifyContent: 'center'}}>
                            ...
                            <View style={{marginLeft: 15, flexWrap: 'wrap'}}>
                                <View style={{shadowColor: themeMode == 'dark' ? '#202020' : '#c9c9c9',
                                    ...
                                    <Text style={{
                                        ...
                                        Aucune actualité à afficher dans cette catégorie
                                        </Text>
                                </View>
                            </View>
                        ) : (
...
export default withNavigation(HomeNewsCampaignComponent);
