...
import { View, Text, TouchableOpacity, ImageBackground, Dimensions, StyleSheet, Image, ActivityIndicator, FlatList, Alert } from 'react-native';
...
class HomeNewsCoopComponent extends React.Component {
    ...
    requestNews = () => {
        if(this.state.isLoaded == false)  {
            ...
            fetch(`https://api.mwaction.app/v1/news/fetchall?app_name=${DeviceInfo.getBundleId()}&limit=4&category=coop`, {
                headers: new Headers({
                    ...
                    <FastImage style={styles.cardBoxImageBackground} source={{uri: item.image}}>
                        <View style={{  backgroundColor: 'rgba(0, 0, 0, 0.5)', height: 200, width: Dimensions.get('window').width / 1.5,}}>
                            ...
                            <View style={{position: 'absolute', top: 10,  right: 10, flexDirection: 'row'}}>
                                ...
                                <View style={{}}>
                                    <View style={{backgroundColor: colorGe, paddingTop: 5, paddingBottom: 5, paddingLeft: 10, paddingRight: 10, borderRadius: 10}}>
                                        <Text style={{fontWeight: '400', color: 'white', fontSize: 12}}>
                    ...
                    <View>
                        {this.state.news.length == 0 ? (
                            ...
                            <FlatList
                                ...
                                ListHeaderComponent={<TouchableOpacity onPress={() => this.props.navigation.navigate('NewsList', {category: 'coop'})} style={{marginRight: 15}}>
                                                        <View>
...
export default withNavigation(HomeNewsCoopComponent);